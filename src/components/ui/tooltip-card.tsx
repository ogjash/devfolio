      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-md border border-transparent bg-background ring-1 ring-primary/10 dark:bg-background dark:ring-primary/10"
            style={{
              top: position.y,
              left: position.x,
            }}
